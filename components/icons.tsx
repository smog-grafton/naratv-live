...
export const IconLogo = (props: React.SVGProps<SVGSVGElement>) => (
  <svg width="40" height="40" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <rect width="100" height="100" rx="8" fill="currentColor"/>
    <path d="M25 75V25H50C63.8071 25 75 36.1929 75 50C75 63.8071 63.8071 75 50 75H25ZM40 60H50C55.5228 60 60 55.5228 60 50C60 44.4772 55.5228 40 50 40H40V60Z" fill="#050B12"/>
  </svg>
);
